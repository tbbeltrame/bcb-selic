...
export class SelicService {
  ...
  private readonly SELIC_API = 'http://api.bcb.gov.br/dados/serie/bcdata.sgs.11/dados?formato=json';

  constructor(private http: HttpClient) { }

  getSelic(dataInicial: string, dataFinal: string): Observable<SelicResponse[]> {
